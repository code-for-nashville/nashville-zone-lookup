defmodule Mix.Tasks.NashvilleZoneLookup.IngestLandUseTable do
  @moduledoc ~S"""
  ...
  alias NashvilleZoneLookup.Utils.Enum, as: EnumUtils
  ...
  def ensure_zones_and_land_use_conditions() do
    ...
    # `Zone`s
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        code: "AG",
        category: NashvilleZoneLookup.Zoning.Zone.category_agricultural(),
        description:
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        code: "RS80",
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Relatively low to moderate intensity single-family development.  20,000 sqaure foot lot."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Relatively low to moderate intensity single-family development.  15,000 sqaure foot lot."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Relatively low to moderate intensity single-family development.  10,000 sqaure foot lot."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Low to moderate intensity one-family and two-family development.  30,000 square foot lot."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Low to moderate intensity one-family and two-family development.  20,000 square foot lot."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Medium intensity one-family and two-family development.  15,000 square foot lot."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Medium intensity one-family and two-family development.  10,000 square foot lot."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Medium intensity one-family and two-family development.  8,000 square foot lot."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Higher intensity one-family and two-family development.  6,000 square foot lot."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Low intensity multi-family structures of one, two or three stories.  2 units an acre."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Low intensity multi-family structures of one, two or three stories.  4 units an acre."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Low to medium intensity multifamily development of two-story or three-story structures.  6 units an acre."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_residential(),
        description:
          "Low to medium intensity multifamily development of two-story or three-story structures.  9 units an acre."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        code: "SP",
        category: NashvilleZoneLookup.Zoning.Zone.category_specific_plan(),
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        code: "MUN",
        category: NashvilleZoneLookup.Zoning.Zone.category_mixed_use(),
        description:
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_mixed_use(),
        description:
          "Mixed-use limited.  Moderate intensity mixture of residential, office, personal service and retail shopping."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_mixed_use(),
        description:
          "Mixed-use limited alternative.  Moderate intensity mixture of residential, office, personal service and retail shopping."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_mixed_use(),
        description:
          "Mixed-use general.  Moderately high intensity mixture of residential, office, personal service and retail shopping."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_mixed_use(),
        description:
          "Mixed-use general alternative.  Moderately high intensity mixture of residential, office, personal service and retail shopping."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_mixed_use(),
        description:
          "Mixed-use intensive alternative.  High intensity mixture of residential, office, personal service and retail shopping."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        code: "ON",
        category: NashvilleZoneLookup.Zoning.Zone.category_office(),
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_office(),
        description:
          "A mixture of compatible office and multifamily residential use at medium-high density levels of intensity.  20 units an acre."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_office(),
        description:
          "A mixture of compatible office and multifamily residential use at medium-high density levels of intensity.  40 units an acre."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_office(),
        description:
          "High intensity office uses mutually compatible with high-density residential uses."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        code: "CN",
        category: NashvilleZoneLookup.Zoning.Zone.category_commercial(),
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_commercial(),
        description:
          "Commercial limited.  Limited range of commercial uses primarily concerned with retail trade and consumer services, general and fast food restaurants, financial institutions, administrative and consulting offices"
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_commercial(),
        description:
          "Commercial services.  Diverse range of commercial uses that include retail trade and consumer services, automobile sales and repair, small scale custom assembly, restaurants, entertainment, and financial services."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_commercial(),
        description:
          "Commercial attractions.  Amusement and recreational uses in association with overnight accommodations and a variety of retail and support services typically affiliated with the tourist industry."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_commercial(),
        description:
          "Core frames.  A diverse variety of business service functions along with retail trade and consumer service establishments and large parking structures that require locations in proximity to the central business district."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        code: "North",
        category: NashvilleZoneLookup.Zoning.Zone.category_downtown(),
        description:
          "Downtown North.  A broad range of residential and non-residential activities associated with an economically healthy, socially vibrant, and sustainable Downtown."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_downtown(),
        description:
          "Downtown Sorth.  A broad range of residential and non-residential activities associated with an economically healthy, socially vibrant, and sustainable Downtown."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_downtown(),
        description:
          "Downtown West.  A broad range of residential and non-residential activities associated with an economically healthy, socially vibrant, and sustainable Downtown."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_downtown(),
        description:
          "Downtown Central.  A broad range of residential and non-residential activities associated with an economically healthy, socially vibrant, and sustainable Downtown."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        code: "SCN",
        category: NashvilleZoneLookup.Zoning.Zone.category_shopping_center(),
        description:
          "Shopping center neighborhood.  Local retail and service trades catering specifically to the recurring shopping needs of nearby residences."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_shopping_center(),
        description:
          "Shopping center community.  Retail and service trades catering to a community-scale market of approximately thirty-five thousand to one hundred thousand people."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_shopping_center(),
        description:
          "Shopping center regional.  Retail and service trades catering to a regional market area, supporting the development of shopping malls with large specialized retail anchors."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        code: "IWD",
        category: NashvilleZoneLookup.Zoning.Zone.category_industrial(),
        description:
          "Industrial warehousing.  Wholesaling, warehousing and bulk distribution uses."
      },
      on_conflict: :nothing
    )
    ...
    NashvilleZoneLookup.Repo.insert!(
      %NashvilleZoneLookup.Zoning.Zone{
        ...
        category: NashvilleZoneLookup.Zoning.Zone.category_industrial(),
        description:
          "Industrial general.  Intensive manufacturing uses that are essential for the economic viability of the metropolitan area."
      },
      on_conflict: :nothing
    )
  end
  ...
  A basic example that ignores the first column and joins the data predictably:
      ...
      iex> Mix.Tasks.NashvilleZoneLookup.IngestLandUseTable.get_zone_groups([
      ...>   ["Ignore", "all", "these"],
      ...>   ["First", "two", "rows"],
      ...>   ["", "AG", "RS80"],
      ...>   ["", "and", "thru"],
  ...
  Returns anything we haven't mapped in @zone_groups_to_zone_codes
      ...
      iex> Mix.Tasks.NashvilleZoneLookup.IngestLandUseTable.get_unmapped_zone_groups([
      ...> "GO",  # not real
      ...> "PREDS" ,  # not real
      ...> "O N"  # real
      ...> ])
  ...
  remaining lines are blank. It also strips out the trailing "Hello":
      ...
      iex> Mix.Tasks.NashvilleZoneLookup.IngestLandUseTable.land_use_category(
      ...>   ["Industrial Uses", "", "", "", ""]
      ...> )
      "Industrial"
  ...
  Empty condition codes are translated to "NP" (Not permitted).
      ...
      iex> Mix.Tasks.NashvilleZoneLookup.IngestLandUseTable.get_zone_land_use_conditions(
      ...>   ["Microbrewery", "A", "P", "", "PC"],
