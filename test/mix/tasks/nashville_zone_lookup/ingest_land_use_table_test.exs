defmodule Mix.Tasks.NashvilleZoneLookup.IngestLandUseTableTest do
  @moduledoc """
  Run through and test output for a very shortened file
  """
  use ExUnit.Case, async: true

  alias Mix.Tasks.NashvilleZoneLookup.IngestLandUseTable
  alias NashvilleZoneLookup.Repo
  alias NashvilleZoneLookup.Zoning.{LandUse, LandUseCondition, Zone}
